...
function(get_include_directories IncludeDirectories)
    ...
    foreach(dir IN LISTS dirs)
      ...
      if ((CLR_CMAKE_PLATFORM_ARCH_ARM AND WIN32) OR (CLR_CMAKE_PLATFORM_ARCH_ARMV6 AND WIN32))
        list(APPEND INC_DIRECTORIES /I${dir})
      else()
        list(APPEND INC_DIRECTORIES -I${dir})
      endif((CLR_CMAKE_PLATFORM_ARCH_ARM AND WIN32) OR (CLR_CMAKE_PLATFORM_ARCH_ARMV6 AND WIN32))
