        ...
        do
        {
            ...
            if (IS_CSE_USE(exp->gtCSEnum))
            {
                ...
                if (sideEffList != nullptr)
                {
                    ...
                    {
                        GenTree* op1 = curSideEff->AsOpRef().gtOp1;
                        GenTree* op2 = curSideEff->AsOpRef().gtOp2;
                    ...
                    if ((curSideEff->OperGet() == GT_CAST) && !curSideEff->gtVNPair.BothDefined())
                    {
                        ...
                        curSideEff = curSideEff->AsOpRef().gtOp1;
                    }
...
bool Compiler::optIsCSEcandidate(GenTree* tree)
{
    ...
    switch (oper)
    {
        ...
        case GT_IND:
            ...
            return (tree->AsOpRef().gtOp1->gtOper != GT_ARR_ELEM);
