    ...
    switch (vnStore->TypeOfVN(vnCns))
    {
        case TYP_FLOAT:
        {
            ...
            if (tree->TypeGet() == TYP_INT)
            {
                ...
                tree->AsIntCon()->gtIconVal = *(reinterpret_cast<int*>(&value));
        ...
        case TYP_DOUBLE:
        {
            ...
            if (tree->TypeGet() == TYP_LONG)
            {
                ...
                tree->AsIntConCommon()->SetLngValue(*(reinterpret_cast<INT64*>(&value)));
                tree->gtVNPair = ValueNumPair(vnLib, vnCns);
            }
            else
            {
...
#endif
            {
                switch (tree->TypeGet())
                {
                    case TYP_INT:
                        ...
                        newTree = optPrepareTreeForReplacement(tree, tree);
                        tree->ChangeOperConst(GT_CNS_INT);
                        tree->AsIntCon()->gtIconVal = (int)value;
                        tree->gtVNPair                = ValueNumPair(vnLib, vnCns);
                        break;
                    ...
                    case TYP_LONG:
                        ...
                        newTree = optPrepareTreeForReplacement(tree, tree);
                        tree->ChangeOperConst(GT_CNS_NATIVELONG);
                        tree->AsIntConCommon()->SetLngValue(value);
                        tree->gtVNPair = ValueNumPair(vnLib, vnCns);
                        break;
                    ...
                    case TYP_DOUBLE:
                        ...
                        newTree = optPrepareTreeForReplacement(tree, tree);
                        tree->ChangeOperConst(GT_CNS_DBL);
                        tree->AsDblCon()->gtDconVal = *(reinterpret_cast<double*>(&value));
                        tree->gtVNPair                = ValueNumPair(vnLib, vnCns);
                        break;
...
#endif
            {
                switch (tree->TypeGet())
                {
                    ...
                    case TYP_FLOAT:
                        ...
                        newTree = optPrepareTreeForReplacement(tree, tree);
                        tree->ChangeOperConst(GT_CNS_DBL);
                        tree->AsDblCon()->gtDconVal = *(reinterpret_cast<float*>(&value));
                        tree->gtVNPair                = ValueNumPair(vnLib, vnCns);
                        break;
